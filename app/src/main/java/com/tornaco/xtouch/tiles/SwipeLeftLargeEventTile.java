...
public class SwipeLeftLargeEventTile extends QuickTile {

    private List<String> descList;

    private boolean firstHook = true;

    public SwipeLeftLargeEventTile(Context context) {
        super(context);
        ...
        final int event = SettingsProvider.get().getInt(SettingsProvider.Key.SWIPE_LEFT_LARGE_ACTION);
        ...
        this.tileView = new DropDownTileView(context) {
            ...
            protected void onItemSelected(int position) {
                ...
                SettingsProvider.get().putInt(SettingsProvider.Key.SWIPE_LEFT_LARGE_ACTION, event);
