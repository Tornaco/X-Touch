...
public class SwipeDownEventTile extends QuickTile {

    private List<String> descList;

    private boolean firstHook = true;

    public SwipeDownEventTile(Context context) {
        super(context);
        ...
        final int event = SettingsProvider.get().getInt(SettingsProvider.Key.SWIPE_DOWN_ACTION);
        ...
        this.tileView = new DropDownTileView(context) {
            ...
            protected void onItemSelected(int position) {
                ...
                SettingsProvider.get().putInt(SettingsProvider.Key.SWIPE_DOWN_ACTION, event);
