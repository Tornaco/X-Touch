...
public class SwipeLeftEventTile extends QuickTile {
    ...
    public SwipeLeftEventTile(Context context) {
        ...
        final int event = SettingsProvider.get().getInt(SettingsProvider.Key.SWIPE_LEFT_ACTION);
        ...
        this.tileView = new DropDownTileView(context) {
            ...
            protected void onItemSelected(int position) {
                ...
                SettingsProvider.get().putInt(SettingsProvider.Key.SWIPE_LEFT_ACTION, event);
