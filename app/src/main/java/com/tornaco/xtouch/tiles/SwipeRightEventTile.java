...
public class SwipeRightEventTile extends QuickTile {

    private List<String> descList;

    private boolean firstHook = true;

    public SwipeRightEventTile(Context context) {
        super(context);
        ...
        final int event = SettingsProvider.get().getInt(SettingsProvider.Key.SWIPE_RIGHT_ACTION);
        ...
        this.tileView = new DropDownTileView(context) {
            ...
            protected void onItemSelected(int position) {
                ...
                SettingsProvider.get().putInt(SettingsProvider.Key.SWIPE_RIGHT_ACTION, event);
